...
The Five Core Product Archives are:

1. `README_v0.2.0.md` — immutable released README snapshot.
2. `PRD_v0.2.0.md` — final integrated product definition.
3. `PRODUCT_HANDOFF_v0.2.0.md` — final Product handoff and delivered status.
4. `Interaction_and_Information_Architecture_Spec_v0.2.0.md` — final screen/interaction contract.
5. `AI_DESIGN_v0.2.0.md` — current AI behavior and policy.

Additional authoritative engineering, decision and verification records are:

6. `DECISION_LOG_v0.2.0.md` — chronological durable decision source.
7. `ENGINEERING_REPORT_v0.2.0.md` — implementation, corrections, evidence, CI, reconciliation,
   known limitations, and deferred engineering work.
8. `TECHNICAL_DESIGN_v0.2.0.md` — final technical contract.
9. `FINAL_ACCEPTANCE_v0.2.0.md` — document-and-evidence-based acceptance result.
